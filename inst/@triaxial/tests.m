...
% Copyright (c) Charles Karney (2024) <karney@alum.mit.edu>.
  ...
  n = n + assertEquals(r2n, r2, tol);
  geod = t.carttogeod(r);
  ellip = t.geodtoellip(geod); param = t.elliptoparam(ellip);
  geod = t.paramtogeod(param); param = t.geodtoparam(geod);
  ellip = t.paramtoellip(param); geod = t.elliptogeod(ellip);
  rn = t.geodtocart(geod);
  n = n + assertEquals(rn, r, tol);
  v2 = reshape(r2, 3, 27)';
